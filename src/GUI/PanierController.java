  ...
  static  Button b=new Button();
    ...
    public void liste(){
       ...
       for(int i=0;i<produits.size();i++){
           int j=i;
           HBox h1=new HBox();
           File file = new File("C:\\Users\\ahmed amine\\Documents\\NetBeansProjects\\gameland2\\src\\GUI\\images\\"+produits.get(i).getImage_produit());
    ...
    private void voirpanier(ActionEvent event) {
        ...
        try {
                        Parent root=FXMLLoader.load(getClass().getResource("/GUI/Listeproduitpanier.fxml"));
...
try {
                        Parent root=FXMLLoader.load(getClass().getResource("/GUI/Listecommandecomfirmer.fxml"));
