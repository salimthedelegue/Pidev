...
public class ListecommandecomfirmerController implements Initializable {
    ...
    public void liste(){
       ...
       for(int k=0;k<produits.size();k++){
           int k1=k;
           HBox h11=new HBox();
           File file = new File("C:\\Users\\ahmed amine\\Documents\\NetBeansProjects\\gameland2\\src\\GUI\\images\\"+produits.get(k).getImage_produit());
...
//////////////////////////////
   /* public void down() throws FileNotFoundException{
    ...
    @FXML
    public void qr() throws FileNotFoundException, IOException, InvalidFormatException, org.apache.poi.openxml4j.exceptions.InvalidFormatException{
