...
public class EvenementService {
    ...
    {
        String sql="update evenement set selected=0";
        try {
            ste=cnx.prepareStatement(sql);
            ste.executeUpdate(sql);
    ...
    public Evenement getSelected()
    {
        ...
        String querry ="SELECT * FROM `evenement` where selected =1";
    ...
    {
         String sql="update evenement set selected=1 where reference="+ref;
        try {
            ste=cnx.prepareStatement(sql);
            ste.executeUpdate(sql);
    ...
    public ObservableList<Evenement> afficher1() {
        ...
        while(rs.next()){
            ...
            LocalDate dateDeb = LocalDate.parse(e.getDateD());
           if( LocalDate.now().compareTo(dateDeb)<0)
            evenements.add(e);
        }
   ...
   /* public ObservableList<Evenement> afficher2() {
         ObservableList<Evenement> evenements =FXCollections.observableArrayList(); 
...
String strDate = dateFormat.format(date);  
        ...
        String querry ="SELECT * FROM `evenement` where  date_debut >"+strDate;
