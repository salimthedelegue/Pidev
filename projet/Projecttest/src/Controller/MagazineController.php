...
class MagazineController extends AbstractController
{
    ...
    /**
     * @Route("/FrontMagArt", name="FrontMagArt")
     */
    public function FrontMagArt(MagazineRepository $repository,ArticleRepository $repo): Response
    {
        $articles=$repo->findAll();
        $magazines=$repository->findAll();
        return $this->render('magazine/frontMagazinesArticles.html.twig', [
            'magazines' => $magazines,
            'articles' => $articles,
        ]);
    }
